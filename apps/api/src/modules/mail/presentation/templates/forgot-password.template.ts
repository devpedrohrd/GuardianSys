...
<head>
  <meta charset="utf-8">
  <title>Recuperação de Senha - GuardianSys</title>
  <style>
    body {
...
<body>
  <div class="email-wrapper">
    <div class="email-card">
      ...
      <div class="body">
        <p>Olá,</p>
        <p>Recebemos recentemente uma solicitação para redefinir a senha associada à sua conta no <strong>GuardianSys</strong>.</p>
        ...
        <p>Atenciosamente,<br>Equipe de Suporte GuardianSys</p>
      </div>
      <div class="footer">
        <p>&copy; ${new Date().getFullYear()} GuardianSys. Todos os direitos reservados.</p>
